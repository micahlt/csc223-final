...
8. Start your next large-scale feature or fix by starting over and creating a new branch from `master` (as in step 1).  Alternatively, you can merge `master` into your branch to get it up to date, but that's more complex.